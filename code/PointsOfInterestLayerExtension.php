...
class PointsOfInterestLayerExtension extends DataExtension {
  ...
  public function updateCMSFields( FieldList $fields ) {    
    ...
    $gridConfig2->getComponentByType( 'GridFieldAddExistingAutocompleter' )->setSearchFields( array( 'Name' ) );
    $gridConfig2->getComponentByType( 'GridFieldPaginator' )->setItemsPerPage( 100 );
    $gridField2 = new GridField( "POI Layers", "POI Layers:", $this->owner->PointsOfInterestLayers(), $gridConfig2 );
